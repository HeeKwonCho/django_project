...
# 1. lecture_sites
insert into lecture_sites (site_name, site_url)
values ('Udemy', 'https://www.udemy.com/')
;
insert into lecture_sites (site_name, site_url)
values ('Inflearn', 'https://www.inflearn.com/')
;

# 2. lecture_lecturer
insert into lecture_lecturer (lecturer_name)
select distinct lt.institution
from   lecture_temp lt
;

# 3. lecture_categories
# 3-1. Udemy level 1
insert into lecture_categories (cat_name)
...
# 4. lecture_lectures
insert into lecture_lectures (site_id, category_id, lecturer_id, lec_title, lec_img_link, lec_link, rating, review_count)
select (select ls.id
